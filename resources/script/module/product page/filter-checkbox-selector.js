...
const URL_PATHNAME = location.pathname.split('/').slice(-1)[0];
...
const checkPathname = () => {
  if (URL_PATHNAME === 'men-outerwear' || URL_PATHNAME === 'men-outerwear.html') {
    checkElement(pathNameAndClassname.men);
  }

  if (URL_PATHNAME === 'women-clothing' || URL_PATHNAME === 'women-clothing.html') {
    checkElement(pathNameAndClassname.women);
  }

  if (URL_PATHNAME === 'jewelery' || URL_PATHNAME === 'jewelery.html') {
    checkElement(pathNameAndClassname.jewelery);
  }

  if (URL_PATHNAME === 'electronics' || URL_PATHNAME === 'electronics.html') {
